...
//        findViewById(ResFinder.getId("umeng_comm_setting_recommend")).setOnClickListener(this);
        findViewById(ResFinder.getId("umeng_comm_friends")).setOnClickListener(new Listeners.LoginOnViewClickListener() {
            @Override
            protected void doAfterLogin(View v) {
                showFriendsFragment();
            }
        });
        findViewById(ResFinder.getId("umeng_comm_myfocustopic")).setOnClickListener(new Listeners.LoginOnViewClickListener() {
            @Override
            protected void doAfterLogin(View v) {
                gotoMyFollowActivity();
            }
        });
        findViewById(ResFinder.getId("umeng_comm_mypics")).setOnClickListener(new Listeners.LoginOnViewClickListener() {
            @Override
            protected void doAfterLogin(View v) {
                gotoMyPicActivity();
            }
        });
        findViewById(ResFinder.getId("umeng_comm_favortes")).setOnClickListener(new Listeners.LoginOnViewClickListener() {
            @Override
            protected void doAfterLogin(View v) {
                showFavoritesFeed();
            }
        });
        findViewById(ResFinder.getId("umeng_comm_notification")).setOnClickListener(new Listeners.LoginOnViewClickListener() {
            @Override
            protected void doAfterLogin(View v) {
