...
import com.umeng.comm.ui.imagepicker.presenter.impl.RecommendTopicFgPresenter;
 ...
 */
public class CategoryTopicPresenter  extends RecommendTopicFgPresenter {
    protected MvpRecommendTopicView mRecommendTopicView;

    private String mNextPageUrl = "";

    public CategoryTopicPresenter(MvpRecommendTopicView recommendTopicView) {
        super(recommendTopicView);
        mRecommendTopicView = recommendTopicView;
    }
